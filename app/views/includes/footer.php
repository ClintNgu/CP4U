...
<footer class="d-flex align-items-center justify-content-around">
  ...
  <div class="main-right-container border-top border-bottom border-top-light border-bottom-light 
...
<!-- scroll up btn js -->
<script type='text/javascript' src='<?= URL_ROOT ?>/js/index.js'></script>
