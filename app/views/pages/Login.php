...
<div class="login-container d-flex align-items-center justify-content-center">
	<div class="left p-1 ps-4 mx-5">
		...
		<a href="<?= URL_ROOT ?>/products" class="btn text-center mt-4 text-light text-uppercase fw-bolder">SHOP NOW</a>
	</div>
	<div class="right p-5 ms-4">
		<div class='d-flex align-items-center'>
			<h4 class="d-inline m-0" style="font-weight: 900;">Login</h4>
		...
		<form method='post' class='mt-4'>
			...
			<button style='font-weight: bold;' type='submit' class='submit-button p-2 w-100 d-block mt-4 btn btn-dark'><span>Login</span></button>
